    ...
    font(Rails.public_path + "/NanumGothic.ttf") do
      ...
      entries.each do |entry|
        ...
        table([
                           ...
                           [{:content => "부가세", :align => :center, :valign => :center}, {:content => "", :colspan => 2, :align => :center, :valign => :center}, {:content => "지출일자", :align => :center, :valign => :center}, {:content => entry.invoice_datetime.to_s, :colspan => 2, :align => :center, :valign => :center}],
