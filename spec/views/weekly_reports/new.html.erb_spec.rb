# require 'spec_helper'
# 
# describe "weekly_reports/new" do
#   before(:each) do
#     assign(:weekly_report, stub_model(WeeklyReport,
#       :team_id => 1,
...
#   end
# 
#   it "renders new weekly_report form" do
#     render
# 
#     # Run the generator again with the --webrat flag if you want to use webrat matchers
#     assert_select "form", :action => weekly_reports_path, :method => "post" do
