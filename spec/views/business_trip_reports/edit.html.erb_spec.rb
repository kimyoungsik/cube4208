...
describe "business_trip_reports/edit" do
  before(:each) do
  ...
  it "renders the edit business_trip_report form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => business_trip_reports_path(@business_trip_report), :method => "post" do
